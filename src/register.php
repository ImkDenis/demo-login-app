...
<body>
  ...
  <div class="container">
    <div class="row g-0">
      ...
      <div class="register-section col-lg-5 px-4 mx-auto">
        ...
        <form action="register.php" method="post">
          <div class="form-row">
            <input type="email" class="form-control my-4 py-2" name="email" aria-describedby="emailHelp" placeholder="E-mail" required>
          </div>
          <div class="form-row">
