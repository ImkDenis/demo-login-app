...
<body>
  ...
  <div class="container">
    <div class="row g-0">
      ...
      <div class="login-section col-lg-5 px-4 mx-auto">
        <?php
        if (isset($_REQUEST['msg'])) {
          echo "<p class='error success'>" . $_REQUEST['msg'] . "</p>";
        }
        ?>
        <svg class="mx-auto my-2" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-person-square" viewBox="0 0 16 16">
